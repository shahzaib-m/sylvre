...
namespace Sylvre.Core.Models
{
    ...
    public class SylvreProgram
    {
        ...
        /// </summary>
        public ICollection<SylvreParseError> ParseErrors { get; private set; }
        /// <summary>
        ...
        public SylvreProgram(ProgramContext sylvreCstRoot, ICollection<SylvreParseError> parseErrors)
        {
